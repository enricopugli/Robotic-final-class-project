...
\begin{column}{0.5\textwidth}
	\begin{figure}
	\movie[width=\linewidth]{}{video/PidPointToPoint.avi}
	\end{figure}
\end{column}
\end{columns}
\end{frame}
...
\begin{column}{0.5\textwidth}
	\begin{figure}
	\frame{\includegraphics[width=\linewidth]{img/computedTorque/Visualizzatore.png}}
	\end{figure}
\end{column}
\end{columns}
\end{frame}
...
\begin{column}{0.5\textwidth}
	\begin{figure}
	\frame{\includegraphics[width=\linewidth]{img/backstepping/Visualizzatore.png}}
	\end{figure}
\end{column}
\end{columns}
\end{frame}
