...
E_9 = [E_x1x400(5:6,:);E_x1x400(23:24,:)];
E_10 = [E_x1x400(5:6,:);E_x1x400(39:40,:)];

E58 = E(:,5:8);
E_x1x2x4x5x600 = subs(E58, [x(1), x(2), x(4), x(5), x(6)], [0, 0,0,0,0]);
fprintf('0 0 ');
fprintf('################\n');
...
for i=1:6
    disp(j)
    E_x1x2x4x5x600(j:j+7,1:4)
    j = j+8;
end    

E58 = E(:,5:8);
E_x2x300 = subs(E58, [x(2),x(3)], [0, 0]);
fprintf('0 0 ');
fprintf('################\n');
...
E_11 = [E_x2x300(5:6,:);E_x2x300(23:24,:)];
E_12 = [E_x2x300(5:6,:);E_x2x300(39:40,:)];