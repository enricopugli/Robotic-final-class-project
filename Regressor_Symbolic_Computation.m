...
for i = 1:3
    ...
    C1 = c1(~cellfun('isempty',regexp(C1,'\w*\*\w*','match')));
    ...
    C2 = c2(~cellfun('isempty',regexp(C2,'\w*\*\w*','match')));
    ...
    %---------------------------------------------------------------------
    [c3,t3] = coeffs(Dyn(i), [m_fb,r_m]);
    C3 = arrayfun(@char,t3,'Un',0);
    C3 = c3(~cellfun('isempty',regexp(C3,'\w*\*\w*','match')));
    ...
    C4 = c4(~cellfun('isempty',regexp(C4,'\w*\*\w*','match')));
    ...
    C5 = c5(~cellfun('isempty',regexp(C5,'\w*\^\w*\*\w*','match')));
    ...
    C6 = c6(~cellfun('isempty',regexp(C6,'\w*\^\w*\*\w*','match')));
