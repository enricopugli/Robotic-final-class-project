...
saveas(gcf, '..\Img\AdaptiveInfinity\Eerror', 'epsc')
...
saveas(gcf, '..\Img\AdaptiveInfinity\tau', 'epsc')
...
saveas(gcf, '..\Img\AdaptiveInfinity\Power', 'epsc')
...
legend('ee_z', 'ee_r_z')
saveas(gcf, '..\Img\AdaptiveInfinity\confronto', 'epsc')
...
%     line([P1(1) P3(1)],[P1(2) P3(2)],[P1(3) P3(3)]);
    ...
    saveas(gcf, '..\Img\AdaptiveInfinity\Visualizzatore', 'png')
