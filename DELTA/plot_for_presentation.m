...
saveas(gcf, '..\Img\BackStepping\Eerror', 'epsc')
...
saveas(gcf, '..\Img\BackStepping\tau', 'epsc')
...
saveas(gcf, '..\Img\BackStepping\Power', 'epsc')
...
legend('ee_z', 'ee_r_z')
saveas(gcf, '..\Img\BackStepping\confronto', 'epsc')
...
%     line([P1(1) P3(1)],[P1(2) P3(2)],[P1(3) P3(3)]);
    ...
    saveas(gcf, '..\Img\BackStepping\Visualizzatore', 'png')
