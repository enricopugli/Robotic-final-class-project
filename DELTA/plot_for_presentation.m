...
saveas(gcf, '..\Img\AdaptiveCircle\Eerror', 'epsc')
...
saveas(gcf, '..\Img\AdaptiveCircle\tau', 'epsc')
...
saveas(gcf, '..\Img\AdaptiveCircle\Power', 'epsc')
...
legend('ee_z', 'ee_r_z')
saveas(gcf, '..\Img\AdaptiveCircle\confronto', 'epsc')
...
%     line([P1(1) P3(1)],[P1(2) P3(2)],[P1(3) P3(3)]);
    ...
    saveas(gcf, '..\Img\AdaptiveCircle\Visualizzatore', 'png')
